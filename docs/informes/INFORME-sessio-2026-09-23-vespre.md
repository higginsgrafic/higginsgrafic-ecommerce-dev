...
> (1280, 1366, 1024), i **123 px** a la **tauleta vertical** (600–1024
...
>
> **I els 116 de la vertical són ara 123** (61 px la fila del logo i les icones
> + 62 la del menú): amb 116 el layout reservava 7 px menys del que la capçalera
> ocupa, i els primers 7 px de la pàgina queien sota seu. El megaslide ja hi
> penjava, dels 123, així que ara la pàgina i el panell comencen al mateix lloc.
> La hero NO es mou: la seva cel·la arrenca de la vora del panell, i l'única
> peça que es desplaça són les icones, 3,5 px (estan centrades en una cel·la
> 7 px més curta).
