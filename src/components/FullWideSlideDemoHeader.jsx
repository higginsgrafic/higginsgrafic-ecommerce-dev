  ...
  return (
    <div style={{
      ...
      {activeTab === 'COMPTE' && (<>
        ...
        `}</style>
        <div style={{ width: '1320px', marginLeft: 'auto', marginRight: 'auto', marginTop: '-0.5px', overflow: 'hidden', position: 'relative', backgroundImage: 'url("/tmp/USER/FONS%20COMPTE.png")', backgroundRepeat: 'no-repeat', backgroundPosition: 'top left', backgroundSize: '1320px 100%' }}>
      ...
      `}</style>
      <div style={{ width: '1320px', marginLeft: 'auto', marginRight: 'auto', marginTop: '-0.5px', overflow: 'hidden', position: 'relative', backgroundImage: 'url("/tmp/USER/FONS%20COMANDES.png")', backgroundRepeat: 'no-repeat', backgroundPosition: 'top left', backgroundSize: '1320px 100%' }}>
