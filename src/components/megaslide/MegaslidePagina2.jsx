          ...
          <TaulaVerticalP2
            ...
            stripe={(
              ...
              <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
                <div style={{ height: '100%', transform: 'translateY(-130.45px) scale(2.027)', transformOrigin: 'center center', '--megaStripeDx': '0px', '--megaStripeDy': '0px', '--hgStripeDrawingExtraScale': '1.5' }}>
                  <MegaStripePanel
                    {...propsFranjaP2}
                    isPortraitTablet
