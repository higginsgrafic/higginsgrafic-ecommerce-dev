      ...
      >
        ...
        >
          ...
          >
            <div style={{
              position: 'absolute',
              // AQUESTA CAPA VA SOBRE L'AMPLADA DE MAQUETACIO, COM TOT LA RESTA.
              //
              // Fins al 24/09/2026 feia `width: 100vw` i es desplacava amb
              // `--site-gutter-mig` (mitja reserva de la barra) perque queia a
              // sobre de la FINESTRA. Pero el carril, la fila del header i les
              // guies es calculen amb l'amplada de MAQUETACIO
              // (`document.documentElement.clientWidth`, que exclou la barra):
              // amb una barra classica de 15 px (Firefox amb ratoli), la capa
              // era 15 px mes ampla i, com que va centrada, el carril de dins
              // queia 7,5 px a la dreta del de les guies. El selector hi sortia
              // 7,5 px a la dreta i l'amo ho va veure de seguida ("tornem-hi,
              // alinea el selector a l'esquerra del carril").
              //
              // Amb `100%` i sense desplacament, la capa fa l'amplada de
              // maquetacio i el seu centre es el mateix que el del marc del lloc
              // (SiteFrame tambe el calcula amb clientWidth): tot cau al mateix
