...
const OVERLAY_STATE_STORAGE_KEY = 'hg.constructorColleccio04.overlayOpacity.v1';
...
function ConstructorColleccio04Page() {
  ...
  // Alinea el "04" amb el left del logo GRAFC del header.
  useEffect(() => {
  ...
  return (
    <section className="bg-background">
      <Helmet>
        <title>Col·lecció 04 · Constructor | Higgins Gràfic</title>
        <meta
          name="description"
          ...
          [0, 1, 2, 3].map((colIdx) => {
            ...
            return (
              <Card
                ...
                cartCount={0}
                onAddToCart={() => {}}
                editableIdPrefix="constructor-colleccio04-tdp"
      ...
      >
        <strong className="mb-2 block">Controls col·lecció 04</strong>
...
export default ConstructorColleccio04Page;
