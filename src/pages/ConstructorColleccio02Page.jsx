...
const OVERLAY_STATE_STORAGE_KEY = 'hg.constructorColleccio02.overlayOpacity.v1';
...
function ConstructorColleccio02Page() {
  ...
  // Alinea el "02" amb el left del logo GRAFC del header.
  useEffect(() => {
  ...
  return (
    <section className="bg-background">
      <Helmet>
        <title>Col·lecció 02 · Constructor | Higgins Gràfic</title>
        <meta
          name="description"
      ...
      >
        ...
        >
          ...
          >
            <span style={{ display: 'block', transform: 'translateX(6px)' }}>THE HUMAN</span>
            <span style={{ display: 'block', transform: 'translateX(5px)' }}>INSIDE</span>
          </h1>
        </div>
          ...
          [0, 1, 2, 3].map((colIdx) => {
            ...
            return (
              <Card
                ...
                cartCount={0}
                onAddToCart={() => {}}
                editableIdPrefix="constructor-colleccio02-tdp"
      ...
      >
        <strong className="mb-2 block">Controls col·lecció 02</strong>
...
export default ConstructorColleccio02Page;
