...
// =============================================================================
//  PDP de producte — MISCEL·LÀNIA · ARTHUR D THE SECOND
// -----------------------------------------------------------------------------
...
const PRODUCT_SLUG = 'miscellania-arthur-d-the-second';
const PRODUCT_ROUTE = 'arthur-d-the-second';
const PRODUCT_NAME = "ARTHUR D THE SECOND";
const COLLECTION_NAME = "MISCEL·LÀNIA";
...
const TDP_IMAGE = (color) => tdpImageFor(COLLECTION_SLUG, PRODUCT_ROUTE, color);
...
function MiscellaniaArthurDTheSecondPage() {
...
export default MiscellaniaArthurDTheSecondPage;
