...
const PRODUCT_SLUG = 'austen-looking-for-my-darcy-yellow-solid';
const PRODUCT_ROUTE = 'looking-for-my-darcy-yellow-solid';
...
function AustenLookingForMyDarcyYellowSolidPage() {
...
export default AustenLookingForMyDarcyYellowSolidPage;
