...
const PRODUCT_SLUG = 'austen-looking-for-my-darcy-yellow-blue-frame';
const PRODUCT_ROUTE = 'looking-for-my-darcy-yellow-blue-frame';
const PRODUCT_NAME = "LOOKING FOR MY DARCY";
const COLLECTION_NAME = "AUSTEN";
const COLLECTION_SLUG = 'austen';
const IMAGE_COLLECTION = 'austen-looking-for-my-darcy';
...
function AustenLookingForMyDarcyYellowBlueFramePage() {
...
export default AustenLookingForMyDarcyYellowBlueFramePage;
