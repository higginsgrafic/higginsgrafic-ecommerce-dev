...
// =============================================================================
//  PDP de producte — AUSTEN · PEMBERLEY HOUSE
// -----------------------------------------------------------------------------
...
const PRODUCT_SLUG = 'austen-pemberley-house';
const PRODUCT_ROUTE = 'pemberley-house';
const PRODUCT_NAME = "PEMBERLEY HOUSE";
const COLLECTION_NAME = "AUSTEN";
const COLLECTION_SLUG = 'austen';
const IMAGE_COLLECTION = 'austen-pemberley';
...
function AustenPemberleyHousePage() {
...
export default AustenPemberleyHousePage;
