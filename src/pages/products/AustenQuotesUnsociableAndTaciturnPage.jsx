...
// =============================================================================
//  PDP de producte — AUSTEN · UNSOCIABLE AND TACITURN
// -----------------------------------------------------------------------------
...
const PRODUCT_SLUG = 'austen-quotes-unsociable-and-taciturn';
const PRODUCT_ROUTE = 'quotes-unsociable-and-taciturn';
const PRODUCT_NAME = "UNSOCIABLE AND TACITURN";
const COLLECTION_NAME = "AUSTEN";
const COLLECTION_SLUG = 'austen';
const IMAGE_COLLECTION = 'austen-quotes';
...
function AustenQuotesUnsociableAndTaciturnPage() {
...
export default AustenQuotesUnsociableAndTaciturnPage;
