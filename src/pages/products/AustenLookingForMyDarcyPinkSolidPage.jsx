...
const PRODUCT_SLUG = 'austen-looking-for-my-darcy-pink-solid';
const PRODUCT_ROUTE = 'looking-for-my-darcy-pink-solid';
...
function AustenLookingForMyDarcyPinkSolidPage() {
...
export default AustenLookingForMyDarcyPinkSolidPage;
