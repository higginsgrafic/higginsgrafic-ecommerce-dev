...
// =============================================================================
//  PDP de producte — THE HUMAN INSIDE · C3-P0
// -----------------------------------------------------------------------------
...
const PRODUCT_SLUG = 'the-human-inside-c3-p0';
const PRODUCT_ROUTE = 'c3-p0';
const PRODUCT_NAME = "C3-P0";
...
function TheHumanInsideC3P0Page() {
...
export default TheHumanInsideC3P0Page;
