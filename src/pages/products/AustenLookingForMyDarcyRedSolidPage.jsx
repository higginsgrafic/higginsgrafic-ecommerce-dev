...
const PRODUCT_SLUG = 'austen-looking-for-my-darcy-red-solid';
const PRODUCT_ROUTE = 'looking-for-my-darcy-red-solid';
...
function AustenLookingForMyDarcyRedSolidPage() {
...
export default AustenLookingForMyDarcyRedSolidPage;
