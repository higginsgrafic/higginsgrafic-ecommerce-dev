...
// =============================================================================
//  PDP de producte — FIRST CONTACT · VULCANS END
// -----------------------------------------------------------------------------
...
const PRODUCT_SLUG = 'first-contact-vulcans-end';
const PRODUCT_ROUTE = 'vulcans-end';
const PRODUCT_NAME = "VULCANS END";
...
function FirstContactVulcansEndPage() {
...
export default FirstContactVulcansEndPage;
