...
// =============================================================================
//  PDP de producte — AUSTEN · KEEP CALM
// -----------------------------------------------------------------------------
...
const PRODUCT_SLUG = 'austen-keep-calm';
const PRODUCT_ROUTE = 'keep-calm';
const PRODUCT_NAME = "KEEP CALM";
const COLLECTION_NAME = "AUSTEN";
const COLLECTION_SLUG = 'austen';
const IMAGE_COLLECTION = 'austen-keep-calm';
...
export default AustenKeepCalmPage;
