  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        'Els dissenys es despinten amb els rentats? — No! Utilitzem impressió DTF (Direct-to-Film) d\'alta qualitat: el dibuix es transfereix a la peça amb calor i queda integrat al teixit. Els dissenys estan fets per durar anys si segueixes les instruccions de cura (rentat a 30°C, del revés, sense assecadora). Oferim garantia de 2 anys contra defectes de fabricació.',
    ...
    <>
      ...
      >
        ...
        <div
          className="relative"
          style={{
            backgroundImage: 'url(/placeholders/tots_els_fons/fons_serveis/serveis-fons-1-columna.webp)',
