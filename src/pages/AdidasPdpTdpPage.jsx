...
export default function AdidasPdpTdpPage() {
  ...
  const product = useMemo(
    () => ({
      id: 'demo-adidas-pdp-tdp',
      slug: 'iron-kong-tdp',
      name: 'IRON KONG',
      description:
        'PDP demo. Objectiu: reciclar la targeta de producte (TDP) i provar una composició menys densa amb 2 columnes.',
      price: 19.99,
      image:
  ...
  return (
    <div className="min-h-screen bg-background" data-page="adidas-pdp-tdp">
