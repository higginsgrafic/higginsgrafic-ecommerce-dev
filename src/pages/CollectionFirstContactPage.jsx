              ...
              <CollectionTdpCard
                ...
                onAddToCart={(size) => {
                  window.dispatchEvent(new CustomEvent('hg:open-full-wide-cart', {
                    detail: { source: 'collection-tdp-cta', firstPartOnly: true, item: { title: productName.toUpperCase(), collection: 'FIRST CONTACT', collectionSlug: 'first-contact', productRoute: productAt(rowIdx, colIdx).route, qty: 1, size, price: SELLING_PRICE_LABEL, color, finish: gridFinishFor('first-contact', color, rowIdx * 4 + colIdx), drawing: '', disabled: false } },
                  }));
                }}
