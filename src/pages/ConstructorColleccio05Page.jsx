...
const OVERLAY_STATE_STORAGE_KEY = 'hg.constructorColleccio05.overlayOpacity.v1';
...
function ConstructorColleccio05Page() {
  ...
  // Alinea el "05" amb el left del logo GRAFC del header.
  useEffect(() => {
  ...
  return (
    <section className="bg-background">
      <Helmet>
        <title>Col·lecció 05 · Constructor | Higgins Gràfic</title>
        <meta
          name="description"
          ...
          [0, 1, 2, 3].map((colIdx) => {
            ...
            return (
              <Card
                ...
                cartCount={0}
                onAddToCart={() => {}}
                editableIdPrefix="constructor-colleccio05-tdp"
      ...
      >
        <strong className="mb-2 block">Controls col·lecció 05</strong>
...
export default ConstructorColleccio05Page;
